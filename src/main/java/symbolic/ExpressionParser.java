...
/**
 * This class has some static methods to create an Expression from a string or a
 * text stream.
 */
public class ExpressionParser implements ExpressionParserConstants {
	...
	/**
	 * Create an Expression reading a text from a stream. The text can be something
	 * like "x+y*sin(z)".
	 * 
	 * @param is a stream
	...
	static final public Expression[] expressionP0l() throws ParseException {
		Expression arga = null;
		Expression argb[] = null;
		if (jj_2_7(60)) {
			arga = expressionP1();
			jj_consume_token(3);
			argb = expressionP0l();
			if (argb.length == 2) {
				if ("" != null)
					return new Expression[] { arga, new Sum(argb[0], argb[1]) };
			} else {
				if ("" != null)
					return new Expression[] { arga, argb[0] };
			}
		} else if (jj_2_8(60)) {
			arga = expressionP1();
			jj_consume_token(4);
			...
			if (argb.length == 2) {
				if ("" != null)
					return new Expression[] { arga, new Sum(b0neg, argb[1]) };
			} else {
				if ("" != null)
					return new Expression[] { arga, b0neg };
			}
		} else if (jj_2_9(60)) {
			arga = expressionP1();
			{
	...
	static final public Expression expressionP1() throws ParseException {
		...
		if (jj_2_10(60)) {
			...
			if (arg.length == 1) {
				...
				if ("" != null)
					return new Product(arg[0], arg[1]);
			}
		} else if (jj_2_11(60)) {
			argb = expressionP2();
			{
	...
	static final public Expression[] expressionP1l() throws ParseException {
		...
		if (jj_2_12(60)) {
			...
			if (argb.length == 2) {
				if ("" != null)
					return new Expression[] { arga, new Product(argb[0], argb[1]) };
			} else {
				if ("" != null)
					return new Expression[] { arga, argb[0] };
			}
			...
			if (argb.length == 2) {
				if ("" != null)
					return new Expression[] { arga, new Product(b0inv, argb[1]) };
			} else {
				if ("" != null)
					return new Expression[] { arga, b0inv };
			}
		} else if (jj_2_14(60)) {
			arga = expressionP2();
			{
	...
	static private boolean jj_3_24() {
		if (jj_scan_token(ONEARGFUNCTION))
			return true;
		if (jj_scan_token(8))
			return true;
		if (jj_3R_2())
