...
public abstract class Expression {
	...
	/**
	 * This method substitutes all the variables with the variable values and
	 ...
	 * @return the evaluated Expression.
	 */
	public Expression substitute(String v, String e) {
		return null;
	}

	/**
	 * Get the priority of the operator described by the expression. This is needed
	 * only for allowing toString() to generate the parenthesis when needed.
	 * 
	 * @return the priority
	 */
