...
public class IonPanel extends JPanel {
    ...
    */
	...
	name.setColumns(6);
	charge.setColumns(6); mu.setColumns(6); 
        cdadc.setColumns(6); phi.setColumns(6); c0.setColumns(6);
        cL.setColumns(6);
	
	setLayout(new GridLayout(1,10));

	add(name); add(charge); add(mu); 
        add(cdadc); add(phi); add(c0);
        add(cL); add(isX); add(isLast); add(remove);
