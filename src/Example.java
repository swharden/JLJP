...
public class Example {
    ...
    /** The example. Make the calculation of a liquid junction between
	a 9 M solution of ZnCl2 on the left (position x=0) , and a 3 M
	solution of KCl on the right (position x=L). Three ions
	are thus present.
	The program writes the calculated voltage on the standard
	error, and a table of the three concentrations and the voltage
	on the standard out.
    */
